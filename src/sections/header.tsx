...
//       backgroundSize: "clamp(20px, 4vw, 36px) clamp(20px, 4vw, 36px)",
...
//   return (
//     <div className="h-9 md:h-10 overflow-hidden relative flex items-center justify-center px-4">
//       <motion.div
//         key={idx}
//         initial={{ y: 40, opacity: 0 }}
//         animate={{ y: 0, opacity: 1 }}
//         exit={{ y: -40, opacity: 0 }}
//         transition={{ duration: 0.45, ease: [0.22, 1, 0.36, 1] }}
//         className="absolute font-mono text-xs sm:text-sm md:text-base tracking-[0.2em] sm:tracking-[0.25em] uppercase text-primary whitespace-nowrap"
//       >
//         {roles[idx]}
//       </motion.div>
//     </div>
...
//       className={
//         primary
//           ? "relative inline-flex items-center gap-2.5 px-5 py-3 sm:px-8 sm:py-4 rounded-2xl font-semibold text-sm cursor-pointer select-none overflow-hidden group bg-primary text-lighttext shadow-[0_8px_32px_color-mix(in_srgb,var(--color-primary)_35%,transparent)] touch-manipulation"
//           : "relative inline-flex items-center gap-2.5 px-5 py-3 sm:px-8 sm:py-4 rounded-2xl font-semibold text-sm cursor-pointer select-none overflow-hidden group bg-text/5 border border-text/10 text-text touch-manipulation"
//       }
//     >
//       <span className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 bg-gradient-to-r from-transparent via-white/15 to-transparent" />
//       {children}
...
//     animate={{ opacity: 1, y: 0 }}
//     transition={{ delay, duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
//     className="flex flex-col items-center gap-1 px-4 py-2.5 sm:px-6 sm:py-3 rounded-2xl bg-text/[0.04] border border-text/[0.08]"
//   >
//     <span
//       className="text-xl sm:text-2xl md:text-3xl font-bold font-rubik"
//       style={{
...
//           <h1
//             className="font-extrabold tracking-tight text-text font-rubik leading-[1.1]"
...
//         {/* Role cycler */}
//         <motion.div variants={item} className="mb-5 sm:mb-6 w-full">
//           <RoleCycler />
//         </motion.div>
...
//         <motion.p
//           variants={item}
//           className="max-w-xs sm:max-w-md md:max-w-xl text-sm sm:text-base md:text-lg leading-relaxed mb-8 sm:mb-10 text-subtext"
//         >
...
//         {/* CTA Buttons */}
//         <motion.div variants={item} className="flex flex-wrap gap-3 sm:gap-4 justify-center mb-10 sm:mb-14 md:mb-16">
//           <MagneticButton href="#projects" primary>
...
//         {/* Stats */}
//         <motion.div variants={item} className="flex flex-wrap gap-3 sm:gap-4 justify-center mb-16 sm:mb-20">
//           <StatPill value="2+" label="Years exp."     delay={0.8}  />
...
//         </span>
//         <motion.div
//           className="w-px h-8 sm:h-10 origin-top bg-gradient-to-b from-primary to-transparent"
//           animate={{ scaleY: [0, 1, 0], opacity: [0, 1, 0] }}
//           transition={{ duration: 2.2, repeat: Infinity, ease: "easeInOut" }}
//         />
//       </motion.div>
