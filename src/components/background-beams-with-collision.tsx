...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "h-96 md:h-[40rem] bg-background dark:bg-darkBackground relative flex items-center w-full justify-center overflow-hidden",
    ...
    >
      ...
      <div
        ref={containerRef}
        className="absolute bottom-0 bg-background dark:bg-darkBackground w-full inset-x-0 pointer-events-none"
        style={{
          boxShadow:
...
// Fixed type definition for CollisionMechanism
