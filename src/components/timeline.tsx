...
const TimelineItem = ({
  ...
  return (
    <div
      ref={ref}
      className="flex justify-start pt-10 pb-10 md:pt-40 md:gap-10"
    >
      ...
      <div className="relative pl-16 md:pr-4 md:pl-4 w-full">
        <motion.div
          ...
          className={`rounded-2xl p-6 md:p-8 transition-all duration-500 relative overflow-hidden
                     ...
                     border border-opacity-20 ${
                       isEven ? "border-primary/30" : "border-secondary/30"
                     }
        ...
        >
          ...
          <div
            className={`absolute inset-0 bg-gradient-to-br ${gradientStart} ${gradientEnd} opacity-10`}
          />

          {/* Enhanced shine effect */}
          <div
            className={`absolute -inset-full h-[400%] w-[400%] rotate-45 bg-gradient-to-tr from-white/10 via-white/5 to-transparent animate-slowShine`}
          />
          ...
          <div className="relative z-10">
            ...
            <motion.div
              ...
              animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
              transition={{ duration: 0.5, delay: 0.5 }}
              className={`timeline-content font-rubik transition-all duration-500 ${
                isContentInView ? "opacity-100" : "opacity-90"
              }`}
            >
              {item.content}
            </motion.div>
          ...
          <div
            className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-primary/70 to-secondary/70 ${
              isContentInView ? "opacity-100" : "opacity-50"
