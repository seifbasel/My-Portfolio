            ...
            {!playing && (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  ...
                  <h3
                    className="font-rubik text-lg font-bold text-white leading-tight"
      ...
      <div className="flex gap-2.5 overflow-x-auto pb-1 w-full max-w-xs scrollbar-none">
        {videos.map((video, i) => (
          ...
          >
            ...
            {/* Accent bar */}
            <div
              className={`absolute top-0 left-0 right-0 h-0.5 origin-left bg-gradient-to-r from-primary to-secondary transition-transform duration-300 ${i === current ? "scale-x-100" : "scale-x-0"}`}
            />
